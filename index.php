...
<head>
	<meta charset="utf-8">
	<title>WAC - Login to Control Panel</title>
...
<body style="background:url(images/bg.jpg) no-repeat; background-size:100% 1000px;">
...
<?php include_once("analyticstracking.php") ?>
	...
	<div id="header">
        ...
        <h1 style="margin-left: 440px; font-family: Georgia;     font-weight: bold; font-size:20px; color: #0060BF"><a href="http://www.webappcare.com/" target="blank">Get In Touch With Us &nbsp;&nbsp;&nbsp; <strong style="color: green">WWW.WEBAPPCARE.COM</strong></a></h1>
