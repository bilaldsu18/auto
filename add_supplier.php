			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					$gump->validation_rules(array(
						...
						'sh_name'    	  => 'required|max_len,100|min_len,3',
						'address'     => 'max_len,200',
					...
					$gump->filter_rules(array(
						...
						'sh_name'    	  => 'trim|sanitize_string|mysql_escape',
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
			...
			if($db->query("insert into supplier_details values(NULL,'$name','$sh_name','$address','$contact1','$contact2',0)"))
			{
                         $msg="$name  Supplier Details Added" ;
						 echo"
						 <script>window.open('add_supplier.php?msg=$msg','_self');</script>
						 ";
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form"  border="1" cellspacing="0" cellpadding="">
                    <tr>
                      <td><span class="man">*</span>Supplier Name:</td>
                      <td><input name="name"placeholder="ENTER SUPPLIER NAME" type="text" id="name" maxlength="200"  class="round default-width-input" value="<?php echo $name; ?>" /></td>
					  <td><span class="man">*</span>Shop Name:</td>
                      <td><input name="sh_name"placeholder="ENTER SUPPLIER SHOP" type="text" id="sh_name" maxlength="200"  class="round default-width-input" value="<?php echo $sh_name; ?>" /></td>
					 <tr> 
                       <td>Contact 1</td>
                      <td><input name="contact1" placeholder="ENTER SUPPLIER CONTACT 1" type="text" id="buyingrate" maxlength="20"   class="round default-width-input" 
					  value="<?php echo $contact1; ?>" /></td>                       
					  <td>Contact 2</td>
                      <td> <input name="contact2"placeholder="ENTER SUPPLIER CONTACT 2" type="text" id="sellingrate" maxlength="20"  class="round default-width-input" value="<?php echo $contact2; ?>"  /></td>
                    </tr>
                    <tr>
                      <td>Address</td>
