...
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
    ...
    $query = "SELECT COUNT(*) as num FROM  customer_details WHERE customer_name  LIKE '%".$_POST['searchtxt']."%' OR customer_cnic LIKE '%".$_POST['searchtxt']."%' OR customer_cell LIKE '%".$_POST['searchtxt']."%'";
...
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!=""){
    ...
    $sql= "SELECT * FROM  customer_details WHERE customer_name  LIKE '%$searchtxt%' OR customer_add LIKE '%$searchtxt%' OR customer_father LIKE '%$searchtxt%' OR customer_cnic = '$searchtxt' OR customer_cell LIKE '%$searchtxt%'  LIMIT $start, $limit";
}
...
while($row = mysql_fetch_array($result))
{
    ...
    <tr>
        ...
        <td><?php echo $row['customer_father']; ?></td>
        <td><?php echo $row['customer_cnic']; ?></td>
        <td> <?php echo $row['customer_cell']; ?></td>
        <td>
            <a href="update_customer_details.php?sid=<?php echo $row['id'];?>&table=customer_details&return=view_customers.php"	class="table-actions-button ic-table-edit">
            </a> &nbsp;&nbsp;
...
<tr>
    ...
    <td align="center" colspan='7'><div style="margin-left:20px;"><?php echo $pagination; ?></div></td>
