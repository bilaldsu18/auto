                    ...
                    <table width="595" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td align="right"><table width="300" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="150">&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(subtotal) FROM stock_entries where  date BETWEEN '$fromdate' AND '$todate' group by stock_id");?></td>
                                    </tr>
                        ...
                        <tr>
                            <td><table width="100%" style='text-align: center'  border="1" cellspacing="0" cellpadding="5">
                                    ...
                                    <?php
                                    $result = $db->query("SELECT * FROM stock_entries  where    date BETWEEN '$fromdate' AND '$todate' group by stock_id");
