...
<!-- end header -->
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			$sh_name=  trim(mysql_real_escape_string($_POST['sh_name']));
			...
			if($db->query("UPDATE supplier_details  SET supplier_name ='$name',shop_name ='$sh_name',supplier_address='$address',supplier_contact1='$contact1',supplier_contact2='$contact2' where id=$id"))
                        {	
				...
				<form name="form1" method="post" id="form1" action="">
                   <input name="id" type="hidden" value="<?php echo $_GET['sid']; ?>">  
					...
					<td>Supplier Name</td>
					  ...
					  <td>Shop Name</td>
                      <td><input name="sh_name" type="text" id="sh_name" maxlength="200"  class="round default-width-input" value="<?php echo $line->shop_name ; ?> "/></td>
