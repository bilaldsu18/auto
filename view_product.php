...
function confirmSubmit(id,table,dreturn,stock_name)
{ 	     jConfirm('You Want Delete Product', 'Confirmation Dialog', function (r) {
           if(r){ 
               console.log();
                $.ajax({
  			url: "delete.php",
  			data: { id: id, table:table,dlt_stock_name:stock_name,return:dreturn},
...
$SQL = "SELECT * FROM  stock_details WHERE stock_name LIKE '%".$_POST['searchtxt']."%' OR registration_no LIKE '%".$_POST['searchtxt']."%' OR engine_no LIKE '%".$_POST['searchtxt']."%' OR chassis_no LIKE '%".$_POST['searchtxt']."%'  OR date LIKE '%".$_POST['searchtxt']."%'";
...
$query = "SELECT COUNT(*) as num FROM  stock_details WHERE stock_name LIKE '%".$_POST['searchtxt']."%' OR registration_no LIKE '%".$_POST['searchtxt']."%' OR engine_no LIKE '%".$_POST['searchtxt']."%' OR chassis_no LIKE '%".$_POST['searchtxt']."%'  OR date LIKE '%".$_POST['searchtxt']."%'";
...
<td><?php echo $row['quantity']; ?></td>   
  <!-- <td> <?php //$quantity = $db->queryUniqueValue("SELECT quantity FROM stock_avail WHERE name='".$row['stock_name']."'"); echo $quantity; ?></td> -->
    ...
    <td>	<a href="update_stock.php?sid=<?php echo $row['id'];?>&table=stock_details&return=view_product.php" style="background:url(img/icons/table/actions-edit.png)"	class="table-actions-button ic-table-edit">
	</a>
	</td>
	<td>
<a  href="javascript:confirmSubmit(<?php echo $row['id'];?>,'stock_details','view_product.php','<?php echo $row['stock_name'];?>')" style="background:url(img/icons/table/actions-delete.png)"class="table-actions-button ic-table-delete"></a>	
    </td>
