...
<tr>
    ...
    <th>Payment</th>
    <th>Balance</th>
    <th style='width:20%'>Add Payment</th>

</tr>

<?php
$i=1; $no=$page-1; $no=$no*$limit;
$sql =  "SELECT * FROM stock_entries where balance>0 group by stock_supplier_name LIMIT $start, $limit  ";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!=""){
    $searchtxt = $_POST['searchtxt'];
    $sql= "SELECT * FROM stock_entries WHERE stock_name LIKE '%$searchtxt%' OR reg_no LIKE '$searchtxt' OR eng_no LIKE '$searchtxt' OR chas_no LIKE '$searchtxt' OR stock_supplier_name LIKE '%$searchtxt%' AND balance>0  group by stock_supplier_name LIMIT $start, $limit";
}
...
while($row = mysql_fetch_array($result)){
    ...
    <tr>
        ...
        <td><a href="update_out_standing.php?sid=<?php echo $row['stock_id'];?>&table=stock_entries&return=view_out_standing.php">Pay Now</a>

    </tr>
    <?php $i++; } ?>
<tr>

    <td align="center" colspan='6'><div style="margin-left:20px;"><?php echo $pagination; ?></div></td>
