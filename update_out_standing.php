                    ...
                    <form name="form1" method="post" id="form1" action="">
                        ...
                        <table class="form"  border="0" cellspacing="0" cellpadding="0" >
                            ...
                            if(isset($_POST['id'])){
                                ...
                                if($db->query("UPDATE stock_entries  SET balance=$balance,payment=payment+$payment, due='$due' where stock_id='$id'"))
                                {
                                    $db->query("INSERT INTO transactions(type,supplier,payment,balance,rid,due,subtotal)
                                    values('entry','$supplier',$newpayment,$balance,'$id','$due',$subtotal)");
                            ...
                            <form name="form1" method="post" id="form1" action="">
                                ...
                                <tr><td>&nbsp;</td>
                                    <td>Customer</td>
                                    <td><input name="supplier" type="text" id="supplier" maxlength="200" readonly="readonly" class="round default-width-input" value="<?php echo $line->stock_supplier_name  ; ?> "/></td>
                                    <td>Total </td>
