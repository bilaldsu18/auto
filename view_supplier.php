...
&nbsp;&nbsp;<input name="Search" type="submit" class="my_button round blue   text-upper" value="Search">
 ...
 <form action="" method="get" name="limit_go">
     <!--<input name="limit" type="text" class="round my_text_box" id="search_limit" style="margin-left:5px;" value="<?php if(isset($_GET['limit'])) echo $_GET['limit']; else echo "10"; ?>" size="3" maxlength="3">
...
while($row = mysql_fetch_array($result)) 
{
 ?> 
   ...
   <td> <?php echo $row['supplier_address']; ?></td>
    ...
    <td>	<a href="update_supplier.php?sid=<?php echo $row['id'];?>&table=supplier_details&return=view_supplier.php"	type="button" class="js-button"  value="Edit">
	</a>
