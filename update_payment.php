...
<head>
    <meta charset="utf-8">
    <title>WAC - Update Payment</title>
        ...
        <div class="side-content fr">
            ...
            <div class="content-module">
                ...
                <div class="content-module-heading cf">
                    ...
                    <h3 class="fl">Update <Payment></Payment></h3>
                    ...
                    <form name="form1" method="post" id="form1" action="">
                        ...
                        <table class="form"  border="0" cellspacing="0" cellpadding="0">
                            ...
                            if(isset($_POST['id']) and isset($_POST['new_payment'])){
                                ...
                                $receiptid="RCPT".$max;
                                if($db->query("UPDATE stock_sales SET balance=$balance,payment=$payment,installment=installment-1, due='$due' where transactionid='$id'"))
                                {
                                    $db->query("INSERT INTO transactions(slip_no,type,customer,payment,balance,rid,due,subtotal,receiptid)
                                    values('$slip_no','sales','$customer',$newpayment,$balance,'$id','$due',$subtotal,'$receiptid')");
                                    $max = $db->maxOfAll("id", "transactions");
                            ...
                            <form name="form1" method="post" id="form1" action="">
                                ...
                                <tr><td>&nbsp;</td>
                                    ...
                                    <td>Slip No</td>
                                    <td><input type="text" name='slip_no' id='slip_no' class="round default-width-input"/></td>
                                </tr>
                                <tr></tr>
                                <tr><td>&nbsp;</td>
                                    <td>Customer</td>
